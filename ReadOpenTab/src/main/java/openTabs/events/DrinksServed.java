...
public class DrinksServed implements Event {
	private static final String EVENT_NAME = "DRINKS_SERVED";
	
	private long id;
	private List<Integer> menuItems;

	@SuppressWarnings("unused")
	private DrinksServed() {
	}
	
	public DrinksServed(long id, List<Integer> menuItems) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof DrinksServed))
			return false;
		DrinksServed other = (DrinksServed) obj;
		if (id != other.id)
			return false;
		if (menuItems == null) {
